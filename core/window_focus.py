...
def activate_window_title(application_name):
    ...
    for word in words:
        try:
            ...
            print_to_chat(f"ERROR: Error finding application path for '{word}': {e}")
    ...
    if hwnd:
        ...
        try:
            ...
            print_to_chat(f"ERROR: Error opening application '{app_path}': {e}")
    else:
        print_to_chat(
...
if __name__ == "__main__":
    # active_title = activate_window_title("chrome")
    active_title = activate_window_title("Google Chrome")
    print_to_chat(f"Active window title: {active_title}")